...
function GasTable({ gas, isAdmin, onRefresh }) {
  ...
  const saveEdit = async (id) => {
    try {
      ...
      await axios.put(`${API}/api/rice-gas/gas/${id}`, editData, {
    ...
    <table className="khata-table">
      ...
      <tbody>
        {gas.length > 0 ? (
          ...
          <tr>
            <td colSpan={isAdmin ? 5 : 4}>No Gas Records Found</td>
          </tr>
        )}
      </tbody>
    </table>
