  ...
  const fetchData = async () => {
    try {
      ...
      const [
        ...
        axios.get("http://localhost:5000/api/member/all-members", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        }),

        axios.get("http://localhost:5000/api/member/pending-users", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        }),
        ...
        axios.get("http://localhost:5000/api/payment/all", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        }),

        axios.get("http://localhost:5000/api/meal-request/all", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        }),
        axios.get("http://localhost:5000/api/guest-meal/total-cost", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        }),
        axios.get("http://localhost:5000/api/monthly-calculation/current", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        }),
